...
(function () {
    ...
    if ($(".datatable").length > 0) {
      $(".datatable").DataTable({
        lengthMenu: [
          [5, 10, 15, 25, 50, 75, 100, -1],
          [5, 10, 15, 25, 50, 75, 100, "All"],
        ],
    ...
    function colinit() {
      ...
      $(".sidebar-right ul li.submenu a.active")
        .parents("li:last")
        .children("a:first")
        .addClass("active")
        .trigger("click");
    ...
    if ($(".btnFullscreen").length > 0) {
      const btnFullscreenElements =
        document.getElementsByClassName("btnFullscreen");
